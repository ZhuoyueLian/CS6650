...
# Configuration
BASE_URL = "http://shopping-cart-service-alb-804918405.us-west-2.elb.amazonaws.com"
OUTPUT_FILE = "test-results/mysql_test_results.json"
...
def main():
    print("=" * 60)
    print("MySQL Shopping Cart Load Test")
    print("=" * 60)
    ...
    for i in range(50):
        # Use created cart IDs, or fall back to sequential IDs
        cart_id = cart_ids[i] if i < len(cart_ids) else i + 1
